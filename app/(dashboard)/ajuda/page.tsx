  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="h-12 w-12 rounded-xl bg-[#15317B] flex items-center justify-center">
      ...
      <Tabs value={abaAtiva} onValueChange={setAbaAtiva} className="w-full">
        <TabsList className="grid w-full grid-cols-4 lg:grid-cols-8 h-auto gap-1 bg-slate-100 p-1">
          <TabsTrigger
            value="atendimento"
            className="gap-1.5 text-xs py-2 data-[state=active]:bg-[#15317B] data-[state=active]:text-white"
          >
